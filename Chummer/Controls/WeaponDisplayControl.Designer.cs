namespace Chummer.Controls
{
	partial class WeaponDisplayControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.Controls.Add(this.lblWeaponDicePoolLabel);
			this.Controls.Add(this.lblWeaponConceal);
			this.Controls.Add(this.lblWeaponConcealLabel);
			this.Controls.Add(this.lblWeaponRangeExtreme);
			this.Controls.Add(this.lblWeaponRangeLong);
			this.Controls.Add(this.lblWeaponRangeMedium);
			this.Controls.Add(this.lblWeaponRangeShort);
			this.Controls.Add(this.lblWeaponRangeExtremeLabel);
			this.Controls.Add(this.lblWeaponRangeLongLabel);
			this.Controls.Add(this.lblWeaponRangeMediumLabel);
			this.Controls.Add(this.lblWeaponRangeShortLabel);
			this.Controls.Add(this.lblWeaponRangeLabel);
			this.Controls.Add(this.chkIncludedInWeapon);
			this.Controls.Add(this.chkWeaponAccessoryInstalled);
			this.Controls.Add(this.lblWeaponSlots);
			this.Controls.Add(this.lblWeaponSlotsLabel);
			this.Controls.Add(this.lblWeaponSource);
			this.Controls.Add(this.lblWeaponSourceLabel);
